...
class PythonPartitionRefStream(AsyncIterator[RayPartitionRef]):
    def __aiter__(self) -> PythonPartitionRefStream: ...
    async def __anext__(self) -> RayPartitionRef: ...
    async def close(self) -> None: ...
    def finish(self) -> PyExecutionStats: ...

class DistributedPhysicalPlanRunner:
    def __init__(self, worker_startup_timeout: int = 120, cluster_session: Any = None) -> None: ...
    def stop_execution(self) -> None: ...
    def retire_completed_workers(self) -> None: ...
    def get_node_usage_snapshot(self) -> str: ...
    def prepare_node_drain(self, node_id: str, drain_epoch: int) -> str: ...
    def cancel_node_drain(self, node_id: str, drain_epoch: int) -> str: ...
    def retire_node_workers(self, node_id: str, drain_epoch: int) -> str: ...
    def run_plan(
        self, plan: DistributedPhysicalPlan, psets: dict[str, list[RayPartitionRef]]
    ) -> PythonPartitionRefStream: ...
...
class NativeExecutor:
    ...
    def shuffle_active_operations(self) -> int: ...
    def shuffle_active_writes(self, shuffle_ids: list[int]) -> int: ...
    async def run(
        self,
...
class PyDaftExecutionConfig:
    ...
    @property
    def flight_shuffle_recovery_max_inflight(self) -> int: ...
    @property
    def flight_shuffle_recovery_max_consumer_failures(self) -> int: ...
    @property
    def flight_shuffle_recovery_max_depth(self) -> int: ...
    @property
    def flight_shuffle_recovery_wait_warn_ms(self) -> int: ...
    @property
    def flight_shuffle_recovery_max_retained_maps(self) -> int: ...
    @property
    def flight_shuffle_recovery_max_retained_bytes(self) -> int: ...
    @property
